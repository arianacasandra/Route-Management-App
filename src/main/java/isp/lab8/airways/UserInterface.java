...
public class UserInterface {
    ...
    public void createNewRoute() {
        ...
        Scanner scanner = new Scanner(System.in);
        name = scanner.next();
        FilesAndFoldersUtil.createFolder(System.getProperty("user.home") + "/Desktop/myFolder/" + name);
        System.out.println("New route created successfully.");

    }


    public void addWaypointsForRoute(String name) throws IOException, LessWaipoints, ExceptionDoesntExist {
        ...
        if(number < 2)
         throw new LessWaipoints("The number of Waipoints is less than 2.");
        String folderPath = System.getProperty("user.home") + "/Desktop/myFolder/"+name;
        ...
        for (int i = 0; i < number; i++) {
            ...
            FileWriteUtil.writeUsingFiles(json, System.getProperty("user.home") + "/Desktop/myFolder/" + name + "/" + num + ".json");
...
//                    System.out.println("-----------------------");
    ...
    {
        String folderPath = System.getProperty("user.home") + "/Desktop/myFolder";
        File folder = new File(folderPath);
